...
$(NAME):		$(LIBFT) $(MINILIBX) $(OBJECTS) $(HEADER)
				...
				@$(ECHO) "So_Long: $(GREEN)Created ✔️$(DEF_COLOR)"
...
clean:
				...
				@$(ECHO) "So_Long: objc. files$(DEF_COLOR)$(GREEN) Cleaned ✔️$(DEF_COLOR)\n"

fclean:			clean
				@$(MAKE) -C $(LIBFT_PATH) fclean
				@$(RM) $(NAME) $(NAME_BONUS)
				@$(ECHO) "So_Long: exec. files$(DEF_COLOR)$(GREEN) Cleaned ✔️$(DEF_COLOR)\n"
